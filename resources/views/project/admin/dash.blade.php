	...
	<div class="box black span4" onTablet="span6" onDesktop="span4">
		...
		<div class="box-content">
			<ul class="dashboard-list metro">
				...
				<li class="yellow">
					<a href="#">
						<img class="avatar" alt="Bill" src="{{asset('back/img/avatar9.jp') }}g">
					</a>
				...
				<li class="red">
					<a href="#">
						<img class="avatar" alt="Jane" src="{{asset('back/img/avatar5.jp') }}g">
					</a>
				...
				<li class="blue">
					<a href="#">
						<img class="avatar" alt="Kate" src="{{asset('back/img/avatar6.jp') }}g">
					</a>
