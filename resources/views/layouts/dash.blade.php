					...
					<ul class="nav pull-right">
						...
						<li class="dropdown">
							...
							<ul class="dropdown-menu">
								...
								<li><a href="{{url('elnon')}}"><i class="halflings-icon off"></i> Logout</a></li>
							</ul>
						</li>
						<!-- end: User Dropdown -->
					</ul>
			...
			<div id="sidebar-left" class="span2">
				<div class="nav-collapse sidebar-nav">
					<ul class="nav nav-tabs nav-stacked main-menu">
						<li><a href="{{route('dashbord')}}"><i class="icon-bar-chart"></i><span class="hidden-tablet"> Dashboard</span></a></li>	
						<li><a href="{{route('AllCategory')}}"><i class="icon-envelope"></i><span class="hidden-tablet"> All category</span></a></li>
						<li><a href="{{route('AddCatagory')}}"><i class="icon-tasks"></i><span class="hidden-tablet"> Add category</span></a></li>
						<li><a href="{{route('Allbrand')}}"><i class="icon-eye-open"></i><span class="hidden-tablet"> All Brand</span></a></li>
						<li><a href="{{route('AddBrand')}}"><i class="icon-dashboard"></i><span class="hidden-tablet"> add Brand</span></a></li>
						<li>
