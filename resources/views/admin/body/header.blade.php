 <header id="page-topbar">
                <div class="navbar-header">
                    ...
                    <div class="d-flex">
                        ...
                        @php
                            $id = Auth::user()->id;
                            $dataShow = app\Models\User::find($id);
                        @endphp
                        <div class="dropdown d-inline-block user-dropdown">
                            <button type="button" class="btn header-item waves-effect" id="page-header-user-dropdown"
                                data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <img class="rounded-circle header-profile-user" src=" {{ (!empty($dataShow->profile_image)) ?
                                    url('upload/admin_images/'.$dataShow->profile_image) : url('upload/no_image.jpg') }}"
                                    alt="Header Avatar">
                                <span class="d-none d-xl-inline-block ms-1">{{$dataShow->name}}</span>
