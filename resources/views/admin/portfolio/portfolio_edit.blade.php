        ...
        <div class="col-12">
            <div class="card">
                ...
                <form method="POST" action="{{ route('update.portfolio')}}" enctype="multipart/form-data"> 
                    ...
                    <input name="id" type="hidden" value="{{$editportfolio->id}}" />
                            <!-- Title  -->
                    <div class="row mb-3">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                                ...
                                <textarea id="elm1" name="portfolio_description"> value="{{$editportfolio->portfolio_description}}" </textarea>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <img  id="showImage" class="rounded avatar-lg" src="{{asset($editportfolio->portfolio_iamge) }}" alt="Card image cap">
                        </div>
                    </div>
