            ...
            <div class="row justify-content-center">
                <div class="col-xl-6 col-lg-8 col-md-10">
                    <div class="breadcrumb__wrap__content">
                        <h2 class="title">{{$blogdetalils->blog_title}}</h2>
                ...
                <div class="col-lg-8">
                    <div class="standard__blog__post">
                        <div class="standard__blog__thumb">
                            <img src="{{asset($blogdetalils->blog_image)}}" alt="">
                        </div>
                        <div class="blog__details__content services__details__content">
                            <ul class="blog__post__meta">
                                <li><i class="fal fa-calendar-alt"></i> {{ Carbon\Carbon::parse($blogdetalils->created_at)->diffForHumans() }}</li>
                            </ul>
                            <h2 class="title">{{$blogdetalils->blog_title}}</h2>
                            <p>{!!$blogdetalils->blog_description!!}</p>
                        ...
                        <div class="blog__details__bottom">
                            <ul class="blog__details__tag">
                                ...
                                <li class="tags-list">
                                    <a href="#">{{$blogdetalils->blog_tags}}</a>
                                </li>
                            </ul>
