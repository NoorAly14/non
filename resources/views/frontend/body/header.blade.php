            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="menu__wrap">
                        <nav class="menu__nav">
                            <div class="logo">
                                <a href="indexn.html" class="logo__black"><img src="{{asset('frontend/assets/img/logo/logo_blacka.png')}}" alt=""></a>
                                <a href="indexn.html" class="logo__white"><img src="{{asset('frontend/assets/img/logo/logo_whitea.png')}}" alt=""></a>
                            </div>
