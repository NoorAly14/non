...
@endsection
 ...
 <main>
                    ...
                    <div class="row justify-content-center">
                        <div class="col-xl-6 col-lg-8 col-md-10">
                            <div class="breadcrumb__wrap__content">
                                <h2 class="title">{{ $detalisportfolio->portfolio_name }}</h2>
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item"><a href="index.html">Home</a></li>
                                        <li class="breadcrumb-item active" aria-current="page">{{ $detalisportfolio->portfolio_name }}</li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
  ...
  <img src=" {{ asset($detalisportfolio->portfolio_iamge) }} " alt="">
                            </div>
                            <div class="services__details__content">
                                <h2 class="title">{{ $detalisportfolio->portfolio_title }}</h2>
                                <p> {!! $detalisportfolio->portfolio_description !!} </p>
